  ...
  return (
    <SectionWrapper title="Top News">
      <div className="w-100">
        ...
        {/* Mini News Section */}
        <div
          className="section-new d-flex flex-column flex-lg-row justify-content-between"
        ...
        >
          ...
          <div className="d-none d-lg-block" style={{ width: '1px', backgroundColor: '#ccc', margin: '0 10px' }}></div>
          <Link
            href={`/${item6.category}/${item6.slug}`}
            className="text-decoration-none"
            style={{ flex: '0 0 49.2%' }}
            title={item6.slug}
          >
            <MiniNewsCard category={item6.category} title={item6.title} image={item6.image} date={item6.date} />
          </Link>
        </div>
      </div>
    </SectionWrapper>
