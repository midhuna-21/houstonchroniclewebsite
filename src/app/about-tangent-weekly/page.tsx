...
export default function AboutTangentWeeklyPage() {
    return (
        <>
            <Head>
                ...
                <meta
                    name="description"
                    content="Discover how TangentWeekly delivers independent, fact-based journalism focused on U.S. politics, communities, and culture — with no paywalls or clickbait."
                />
            </Head>
                        ...
                        <div style={{ textAlign: 'justify', textJustify: 'inter-word' }}>
                            <div style={{ marginTop: '40px' }}>
                                ...
                                <p style={{ fontSize: '1.15rem', lineHeight: 1.85 }}>
                                    <strong>Tangent Weekly</strong> is an independent, U.S.-focused digital news organization committed to delivering journalism that informs, investigates, and illuminates. Our mission is to tell the stories that shape American life — from Capitol Hill to the Gulf Coast — with clarity, depth, and journalistic care.
                                </p>
                                <p style={{ fontSize: '1.15rem', lineHeight: 1.85 }}>
